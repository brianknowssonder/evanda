          ...
          >
            ...
            >
              ...
              <span className="bg-gradient-to-r from-yellow-400 to-orange-400 bg-clip-text text-transparent">
                #1 Event Ticketing Platform - Demo Mode
              </span>
            </motion.div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-300">
              Quick access to your dashboard features (Demo Mode - No Login Required)
            </p>
          </motion.div>
          ...
          >
            ...
            <div className="relative z-10">
              ...
              >
                ...
                <span className="text-accent-400 font-medium">Demo Mode Active</span>
              </motion.div>
              ...
              <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
                Switch between different user roles using the navigation menu to experience the full platform functionality without any login requirements.
              </p>

              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                <Link
                  to="/admin"
                  className="group px-8 py-4 bg-gradient-to-r from-red-600 to-red-700 text-white rounded-xl font-semibold text-lg hover:from-red-700 hover:to-red-800 transition-all duration-300 transform hover:scale-105 hover:shadow-2xl hover:shadow-red-500/25"
                >
                  <span className="flex items-center">
                    Admin Dashboard
                    <ArrowRight className="ml-2 w-5 h-5 group-hover:translate-x-1 transition-transform" />
                ...
                <Link
                  to="/organizer"
                  className="group px-8 py-4 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-xl font-semibold text-lg hover:from-blue-700 hover:to-blue-800 transition-all duration-300 transform hover:scale-105 hover:shadow-2xl hover:shadow-blue-500/25"
                >
                  <span className="flex items-center">
                    Organizer Dashboard
                    <ArrowRight className="ml-2 w-5 h-5 group-hover:translate-x-1 transition-transform" />
